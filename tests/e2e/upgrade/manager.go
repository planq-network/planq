...
// along with the Evmos packages. If not, see https://github.com/planq-network/planq/v2/blob/main/LICENSE
...
func (m *Manager) GetNodeHeight(ctx context.Context) (int, error) {
	exec, err := m.CreateExec([]string{"planqd", "q", "block"}, m.ContainerID())
	if err != nil {
...
func (m *Manager) GetNodeVersion(ctx context.Context) (string, error) {
	exec, err := m.CreateExec([]string{"planqd", "version"}, m.ContainerID())
	if err != nil {
