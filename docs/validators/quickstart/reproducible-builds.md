...
Build the `planqd` binary deterministically using Docker. {synopsis}
...
``` bash
git clone git@github.com:planq-network/planq.git
```
...
Files:
 7594279acff34ff18ea9d896d217a6db  planqd-0.4.0-linux-amd64
 c083e812acbfa7d6e02583386b371b93  planqd-0.4.0.tar.gz
Checksums-Sha256:
 d087053050ce888c21d26e40869105163c5521cb5b291443710961ac0c892e81  planqd-0.4.0-linux-amd64
 6ca3e5e40240f5e433088fd9b7370440f3f94116803934c21257e1c78fb9653d  planqd-0.4.0.tar.gz
```
