...
Learn how Planq's architecture leverages the Cosmos SDK Proof-of-Stake functionality, EVM compatibility and fast-finality from Tendermint Core's BFT consensus. {synopsis}
...
Planq enables the full composability and modularity of the [Cosmos SDK](https://docs.cosmos.network/).
...
engines of other blockchains. Planq is such an example of an ABCI application
