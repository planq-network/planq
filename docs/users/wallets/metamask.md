...
Connect your Metamask wallet with Planq. {synopsis}
...
::: tip
If you are planning on developing on Planq locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](../../validators/quickstart/run_node.md), or follow the instructions in the [GitHub repository](https://github.com/planq-network/planq/).
:::
...
3. Click the `Connect Wallet` button under `Planq Testnet`
...
```bash
planqd keys unsafe-export-eth-key dev0
```
