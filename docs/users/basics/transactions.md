...
Learn more about transactions on Planq {synopsis}
...
<!-- 
TODO: explain what transactions are on Planq and blockchains. 
...
<!-- TODO: explain which transactions types does Planq support (i.e modules and changes) and provide a few examples. -->
