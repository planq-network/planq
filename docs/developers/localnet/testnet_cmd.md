...
preparing test network with chain-id "planq_1276974-1"
...
```bash
planqd keys add test --recover
```

Check the balance of the account address:

```bash
planqd q bank balances ADDRESS
```
