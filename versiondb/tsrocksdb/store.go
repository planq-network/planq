...
import (
	...
	"github.com/planq-network/planq/v2/versiondb"
)
...
type Store struct {
	...
	// see: https://github.com/planq-network/planq/v2/issues/1683
...
func (s Store) loadWrongData(storeName string) ([]KVPairWithTS, error) {
	...
	for ; iter.Valid(); iter.Next() {
		...
		if binary.LittleEndian.Uint64(ts) != 0 {
			// FIXME: https://github.com/planq-network/planq/v2/issues/1689
			continue
		}
