module github.com/planq-network/planq/v2/versiondb
...
require (
	...
	github.com/planq-network/planq/v2/memiavl v0.0.0-00010101000000-000000000000
...
replace github.com/planq-network/planq/v2/memiavl => ../memiavl
