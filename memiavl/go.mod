module github.com/planq-network/planq/v2/memiavl
...
replace github.com/cosmos/iavl => github.com/planq-network/iavl v0.21.0-alpha.1.0.20241018082450-05a752de1caa
