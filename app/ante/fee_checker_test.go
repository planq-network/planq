...
func TestSDKTxFeeChecker(t *testing.T) {
	...
	minGasPrices := sdk.NewDecCoins(sdk.NewDecCoin("aplanq", sdk.NewInt(10)))
	...
	testCases := []struct {
		...
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder.SetGasLimit(1)
				txBuilder.SetFeeAmount(sdk.NewCoins(sdk.NewCoin("aplanq", sdk.NewInt(10).Mul(types.DefaultPriorityReduction))))
