...
func init() {
	...
	cdc.ModuleCdc.Amino.RegisterConcrete(&RegisterCoinProposal{}, "erc20/RegisterCoinProposal", nil)
	cdc.ModuleCdc.Amino.RegisterConcrete(&RegisterERC20Proposal{}, "erc20/RegisterERC20Proposal", nil)
	cdc.ModuleCdc.Amino.RegisterConcrete(&ToggleTokenConversionProposal{}, "erc20/ToggleTokenConversionProposal", nil)
}
...
func ValidateErc20Denom(denom string) error {
	...
	return planqtypes.ValidateAddress(denomSplit[1])
}
...
func (rtbp *RegisterERC20Proposal) ValidateBasic() error {
	for _, address := range rtbp.Erc20Addresses {
		if err := planqtypes.ValidateAddress(address); err != nil {
...
func (ttcp *ToggleTokenConversionProposal) ValidateBasic() error {
	...
	// denom
	if err := planqtypes.ValidateAddress(ttcp.Token); err != nil {
